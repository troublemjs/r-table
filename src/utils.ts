...
export function renderElement<P = any>(
  renderer: ReactElementType,
  props?: P,
): React.ReactElement | MaybeElement;
export function renderElement<P = any>(
  renderer: React.ReactElement,
  props?: P,
): React.ReactElement<P> | MaybeElement;
export function renderElement<P = any>(
  renderer: any,
  props?: P,
...
export function normalizeColumns<P = any>(
  elements: {} | React.ReactElement<P> | null | undefined,
) {
  const columns: any[] = [];
...
export function callOrReturn<T extends fn>(
  funcOrValue: T,
  ...args: Parameters<T>
): ReturnType<T>;
